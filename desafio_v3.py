...
class ContasIterador:
    ...
    def __next__(self):
        ...
        self._index += 1  # Incremento movido para cá
        return f"""\  
...
def criar_conta(numero_conta, clientes, contas):
    ...
    limite_saques = int(input("Informe o número máximo de saques diários: "))

    conta = ContaCorrente.nova_conta(cliente, numero_conta, limite, limite_saques)
    contas.append(conta)
